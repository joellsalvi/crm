...
public class DataContext {
	...
	static final String BASE_PACKAGE = "crm.empresacomercial.data";

	static final String REPOSITORY_BASE_PACKAGE = "crm.empresacomercial.data.repositories";

	static final String ENTITY_BASE_PACKAGE = "crm.empresacomercial.utils.entities";
